...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { amount: @discount.amount, discount_id: @discount.discount_id, kind: @discount.kind, payment_id: @discount.payment_id } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { amount: @discount.amount, discount_id: @discount.discount_id, kind: @discount.kind, payment_id: @discount.payment_id } }
